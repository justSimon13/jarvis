...
def import_invoices(csv_text: str) -> dict:
    """Importiert/aktualisiert Rechnungen. Gibt {created, updated, skipped_locked, total,
    unmatched} zurück — 'unmatched' listet Rechnungen ohne projekt_id (neue UND bereits
