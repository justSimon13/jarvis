...
DEFINITIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "ps/whoami/uname/date/uptime/free/hostname, außerdem 'systemctl status/is-active/list-*', "
            "'git status/log/diff/show/branch/remote', 'journalctl' ohne Vacuum/Rotate-Flags) laufen "
            "SOFORT und geben das Ergebnis direkt in dieser Antwort zurück — bei einem Fehler (falscher "
            "Pfad, Datei existiert nicht, o.ä.) SELBST nachhaken und mit einem korrigierten Befehl erneut "
            "versuchen (z.B. 'ls ~/' um zu sehen was es wirklich gibt), nicht einfach aufgeben oder Simon "
            "unkommentiert den rohen Fehler zeigen. "
            "Alle anderen Befehle (alles was schreibt/verändert, sudo, unbekannte Programme, verkettete "
            "Befehle mit &&/|) fragen IMMER zuerst eine Freigabe im Dashboard mit dem vollen Befehl an — "
