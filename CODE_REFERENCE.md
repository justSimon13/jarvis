...
Reine Konstanten, keine Logik, `import protocol as P`, referenziert als `P.XXX`. 69 Konstanten (die bisherige Angabe "46" war bereits vor Thread-Umbau Teil A veraltet — mehrere Gruppen wurden seit dem Stand 2026-07-24 ergänzt, ohne die Zahl hier nachzuziehen; jetzt frisch nachgezählt, inkl. der drei `PCM_*`-Konstanten und der fünf neuen Thread-Umbau-Teil-A-Typen):
